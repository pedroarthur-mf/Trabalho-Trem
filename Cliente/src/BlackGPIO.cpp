...
bool BlackGPIO::fail(BlackGPIO::flags f) {
    if (f==readErr) {
        return this->gpioErrors->readError;
    } if (f==writeErr) {
        return this->gpioErrors->writeError;
    } if (f==exportErr) {
        return this->gpioErrors->exportError;
    } if (f==forcingErr) {
        return this->gpioErrors->forcingError;
    } if (f==directionErr) {
        return this->gpioErrors->directionError;
    } if (f==exportFileErr) {
        return this->gpioErrors->gpioCoreErrors->exportFileError;
    } if (f==directionFileErr) {
        return this->gpioErrors->gpioCoreErrors->directionFileError;
    }
